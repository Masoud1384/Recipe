...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20230912021228_cascade the delete behavior recipe")]
    partial class cascadethedeletebehaviorrecipe
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.Recipe", b =>
                {
                    ...
                    b.Property<DateTime>("RegisterDate")
                        ...
                        .HasDefaultValue(new DateTime(2023, 9, 11, 19, 12, 28, 305, DateTimeKind.Local).AddTicks(2703));
            ...
            modelBuilder.Entity("Domain.Entities.RecipeIngredient", b =>
                {
                    ...
                    b.Property<DateTime>("ingredient_add_date")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 9, 11, 19, 12, 28, 304, DateTimeKind.Local).AddTicks(9866));
            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.Property<DateTime>("RegisterDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 9, 11, 19, 12, 28, 305, DateTimeKind.Local).AddTicks(7018));
